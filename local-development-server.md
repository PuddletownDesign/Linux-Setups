...
**This is all on the host OS until otherwise specificed**

Let's focus on working on the host. The only time we will need to ssh in is to do server side configurations. So working with projects will be most comfortable to work on the host OS. This includes git operations.
